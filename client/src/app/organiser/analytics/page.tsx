        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Track your event performance and insights</p>
                </div>
                    ...
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">{overviewStats.totalViews.toLocaleString()}</p>
                    ...
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">{overviewStats.uniqueVisitors.toLocaleString()}</p>
                                <p className="text-xs text-green-600 dark:text-green-400 flex items-center gap-1 mt-1">
                                    <ArrowUpRight className="w-3 h-3" />
                    ...
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">{overviewStats.registrations.toLocaleString()}</p>
                                <p className="text-xs text-green-600 dark:text-green-400 flex items-center gap-1 mt-1">
                                    <ArrowUpRight className="w-3 h-3" />
                    ...
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-900 dark:text-white mt-1">${overviewStats.revenue.toLocaleString()}</p>
                                <p className="text-xs text-green-600 dark:text-green-400 flex items-center gap-1 mt-1">
                                    <ArrowUpRight className="w-3 h-3" />
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className="text-sm font-semibold text-gray-900 dark:text-white">{dailyData.reduce((sum, d) => sum + d.views, 0).toLocaleString()}</span>
                                    </div>
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className="text-sm font-semibold text-gray-900 dark:text-white">{dailyData.reduce((sum, d) => sum + d.registrations, 0)}</span>
                                    </div>
                                    <div className="flex items-end gap-1 h-24">
                                        {dailyData.map((day, i) => (
                                            <div key={i} className="flex-1 flex flex-col items-center gap-1">
                                ...
                                <div>
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className="text-sm font-semibold text-gray-900 dark:text-white">${dailyData.reduce((sum, d) => sum + d.revenue, 0).toLocaleString()}</span>
                                    </div>
                                    <div className="flex items-end gap-1 h-24">
                                        {dailyData.map((day, i) => (
                                            <div key={i} className="flex-1 flex flex-col items-center gap-1">
                                ...
                                <div className="flex items-center justify-center py-6">
                                    <div className="text-center">
                                        <div className="w-32 h-32 rounded-full border-8 border-[#AC1212] flex items-center justify-center">
                                            <span className="text-4xl font-bold text-gray-900 dark:text-white">{overviewStats.conversionRate}%</span>
                                        </div>
                                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Industry avg: 3-5%</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                                    ...
                                    {trafficSources.map((source, i) => (
                                        <div key={i} className="flex items-center justify-between">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-sm text-gray-500 dark:text-gray-400 w-12 text-right">{source.percentage}%</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                {eventPerformance.map((event) => (
                                    <div key={event.id} className="flex items-center justify-between p-4 border rounded-xl hover:bg-gray-50 transition-colors">
                                            ...
                                            <div>
                                                ...
                                                <Badge
                                                    ...
                                                    className={`mt-1 ${event.status === 'approved' ? 'bg-green-50 text-green-700 border-green-200' :
                                                        event.status === 'pending' ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200 border-yellow-200 dark:border-yellow-800' :
                                        ...
                                        <div className="flex items-center gap-8">
                                            <div className="text-center">
                                                <p className="text-lg font-semibold text-gray-900 dark:text-white">{event.views.toLocaleString()}</p>
                                                <p className="text-xs text-gray-500 dark:text-gray-400">views</p>
                                            </div>
                                            <div className="text-center">
                                                <p className="text-lg font-semibold text-gray-900 dark:text-white">{event.registrations}</p>
                                                <p className="text-xs text-gray-500 dark:text-gray-400">registrations</p>
                                            </div>
                                            <div className="text-center">
                                                <p className="text-lg font-semibold text-green-600 dark:text-green-400">${event.revenue.toLocaleString()}</p>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    {topCountries.map((country, i) => (
                                        <div key={i} className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                <span className="text-sm font-medium text-slate-500 dark:text-slate-400 w-6">{i + 1}</span>
                                                <span className="text-sm font-medium text-slate-900 dark:text-white">{country.country}</span>
                                            </div>
                                            <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div className="flex-1 p-4 bg-slate-100 dark:bg-slate-800 rounded-lg text-center">
                                                ...
                                                <p className="text-xs text-slate-500 dark:text-slate-400">Tablet</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
